...
class __TwigTemplate_57b197d8c0f1ee8c77e1619a88f31ec94c4dde66ce338e7e7e869244877d77eb extends \Twig\Template
{
...
";
    ...
    {
        return new Source("<!-- start progress bar item -->
<div class=\"skillbar margin-45px-bottom\"
     data-percent=\"{% spaceless %}{{ fields.field_skill_percentage.content }}%{% endspaceless %}\">
  <span class=\"skill-bar-text text-extra-small text-uppercase text-dark-gray\">{{ fields.title.content }}</span>
  <p class=\"skillbar-bar\"></p>
  <span class=\"skill-bar-percent text-small\"></span>
</div>
<!-- end progress bar item -->
...
", "sites/all/themes/perks/templates/views/skillbar/views-view-fields--skillbar-view.html.twig", "/var/www/drupalvm/drupal/web/perks-employee-website/www/sites/all/themes/perks/templates/views/skillbar/views-view-fields--skillbar-view.html.twig");
    }
}
